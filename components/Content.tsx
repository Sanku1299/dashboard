              ...
              <DialogHeader>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    className="border p-2 rounded-md w-40 mt-4 mb-5"
                  />
                </div>
                <div className=" flex justify-end space-x-2 px-4">
                  <Button onClick={closeDialog} className="rounded-md w-20 border-blue-600 bg-white hover:bg-white border text-blue-600">Cancel</Button>
                  <Button onClick={saveData} className="rounded-md w-20 border-blue-600 bg-blue-700 hover:bg-white hover:text-blue-700 border text-white">Save</Button>
                </div>
              </DialogHeader>
            </DialogContent>
          </Dialog>
